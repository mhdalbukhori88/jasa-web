...
export default function Process() {
  return (
    <section id="proses" className="bg-slate-50 py-20 lg:py-28">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {process.map((item, i) => (
            <Reveal key={item.step} delay={i * 80}>
              <div className="relative h-full overflow-hidden rounded-2xl border border-slate-100 bg-white p-7 shadow-sm">
                <span className="absolute -right-2 -top-4 text-7xl font-black text-brand-50">
                  {item.step}
                </span>
